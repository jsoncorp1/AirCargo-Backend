...
namespace AC.Infrastructure.Migrations
{
    ...
    [Migration("20260718055545_AddOrderDeliveriesAndShipments")]
    partial class AddOrderDeliveriesAndShipments
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AC.Domain.Modules.Shipments.Shipment", b =>
                {
                    ...
                    b.HasIndex("Correlativo")
                        .IsUnique()
                        .HasDatabaseName("ix_shipments_correlativo");
